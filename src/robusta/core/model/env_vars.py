...
SLACK_RESOLVED_MESSAGE_STATE_BACKEND = os.environ.get("SLACK_RESOLVED_MESSAGE_STATE_BACKEND", "memory")
SLACK_RESOLVED_MESSAGE_STATE_TTL_SECONDS = int(
    os.environ.get("SLACK_RESOLVED_MESSAGE_STATE_TTL_SECONDS", 7 * 24 * 60 * 60)
)
SLACK_RESOLVED_MESSAGE_STATE_REDIS_URL = os.environ.get("SLACK_RESOLVED_MESSAGE_STATE_REDIS_URL", "")
SLACK_RESOLVED_MESSAGE_STATE_REDIS_PREFIX = os.environ.get(
    "SLACK_RESOLVED_MESSAGE_STATE_REDIS_PREFIX", "robusta:slack-resolved-message-state:"
)
